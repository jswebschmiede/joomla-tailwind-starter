...
<body class="<?php echo $option
    ...
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
            ...
            <div class="container max-width-adaptive-lg padding-top-xl padding-bottom-xxl reveal-fx reveal-fx--translate-up">
    ...
    <?php if ($templateparams['backTop'] == 1) : ?>
        <div class='progress-wrap'>
            <svg class='svg-content' width='100%' height='100%' viewBox='-1 -1 102 102'>
                <path fill='none' d='M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98' style='transition: stroke-dashoffset 10ms linear 0s; stroke-dasharray: 307.919, 307.919; stroke-dashoffset: 0.351157;'></path>
            </svg>

            <div class='progress-wrap__icon'>
